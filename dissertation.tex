...
%title[Suggestions for members of the Bessa group]{Kick-starting your MS or PhD research} % \title[Subtitle]{Title}
%author{Miguel}{Bessa} % \author{first name}{last name}
...
\include{chapter_7_non-elasticmodelling/chapter_7_non-elasticmodelling} % add more chapters if you need
