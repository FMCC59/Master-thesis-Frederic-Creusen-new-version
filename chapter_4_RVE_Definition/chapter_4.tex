...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{chapter_4_RVE_Definition/figures/ABS100yxmiddle.png}
...
Figure \ref{fig:colored500x} shows a 500x zoom on a road interface to observe the weld between different roads.
\begin{figure}[H]
    \centering
